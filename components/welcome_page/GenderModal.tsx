...
const GenderModal = ({onClose}: {onClose: any}) => {
  ...
  return (
    <section className="absolute bg-primary w-full h-screen-45 tablet:h-screen-85 laptop:h-screen-111 desktop:h-screen-150 flex flex-col justify-center items-center gap-y-16 text-center tablet:flex-row gap-x-28 laptop:gap-x-44 desktop:gap-x-56">
      <div className="flex flex-col items-center" onClick={() => handleGenderSelect('woman')}>
      ...
      <div className="flex flex-col items-center" onClick={() => handleGenderSelect('man')}>
