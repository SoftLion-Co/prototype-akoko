...
const AboutUsSection = () => {
  ...
  return (
    <section className="container ">
      <div className="flex flex-col gap-[55px] mt-[70px] mb-[150px]  tablet:gap-[70px] tablet:mt-[50px] tablet:mb-[270px] laptop:gap-[113px] laptop:mt-[125px] laptop:mb-[252px] desktop:mt-[230px] desktop:mb-[198px] desktop:gap-[129px] ">
        <h1 className="text-center block laptop:hidden ">{t("title")}</h1>
        <div className="flex flex-col items-center  gap-[50px] laptop:flex-row tablet:justify-between tablet:gap-[60px] laptop:gap-[129px] desktop:gap-[147px] ">
          <Image
