...
const SertificateSection = () => {
      ...
      <div className={className}>
        <IoIosArrowUp
          className={classNames(
            !isArrow ? "rotate-180" : "rotate-0",
            "text-[#000000B2] w-[20px] h-[20px] laptop:w-[24px] laptop:h-[28px] desktop:w-[30px] desktop:h-[35px]"
          )}
        />
      </div>
    );
  ...
  return (
    <section className="mt-[50px] flex flex-col gap-[100px]">
      <NavigationComponent links={[{ title: `${t("sertificate-section.title")}`, href: "" }]} />
      <div className="container mb-[160px]">
        <div className="flex flex-row-reverse gap-[45px] tablet:gap-[66px] laptop:gap-[155px]">
          <div className="flex flex-col relative items-center gap-[20px] tablet:items-start tablet:gap-[26px] laptop:gap-[43px] desktop:gap-[50px]">
            ...
            <ButtonComponent
              title={t("sertificate-section.button")}
              cartImage={true}
